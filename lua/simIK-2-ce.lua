...
Matrix jacobian, Vector errorVector = simIK.computeGroupJacobian(int environmentHandle, int ikGroupHandle)
...
Pose pose = simIK.getJointPose(int environmentHandle, int jointHandle)
Quaternion quat = simIK.getJointQuaternion(int environmentHandle, int jointHandle)
...
simIK.setObjectPose(int environmentHandle, int objectHandle, Pose pose, int relativeToObjectHandle=simIK.handle_world)
simIK.setObjectMatrix(int environmentHandle, int objectHandle, Matrix4x4 m, int relativeToObjectHandle=simIK.handle_world)
simIK.setObjectPosition(int environmentHandle, int objectHandle, Vector3 pos, int relativeToObjectHandle=simIK.handle_world)
simIK.setObjectQuaternion(int environmentHandle, int objectHandle, Quaternion quat, int relativeToObjectHandle=simIK.handle_world)
Pose pose = simIK.getObjectPose(int environmentHandle, int objectHandle, int relativeToObjectHandle=simIK.handle_world)
Matrix4x4 m = simIK.getObjectMatrix(int environmentHandle, int objectHandle, int relativeToObjectHandle=simIK.handle_world)
Vector3 pos = simIK.getObjectPosition(int environmentHandle, int objectHandle, int relativeToObjectHandle=simIK.handle_world)
Quaternion quat = simIK.getObjectQuaternion(int environmentHandle, int objectHandle, int relativeToObjectHandle=simIK.handle_world)
simIK.setObjectParent(int environmentHandle, int objectHandle, int parentObjectHandle, bool keepInPlace=true)
simIK.setJointQuaternion(int environmentHandle, int jointHandle, Quaternion quat)
